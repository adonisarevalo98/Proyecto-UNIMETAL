...
while ($row = mysqli_fetch_row($lis)){   
    ...
    echo "<td width='5%' align='left'><a class='btn btn-success' href=../html/ActualizarArticulo.php?codarticulo=$row[0] style='text-decoration:none'>Actualizar</a></td>";
    echo "<td width='5%' align='left'><a class='btn btn-danger' href=EliminarArticulo.php?codarticulo=$row[0] style='text-decoration:none'>Eliminar</a></td>" ;
    echo "</tr>";
}  
echo "</table> </div>";  
?> 
