...
<nav class="navbar navbar-default">
 ...
 include("../php/funcion.php");  
    $link = mostrar(); 
    $lis = mysqli_query($link,"SELECT * From catarticulos");
    echo "<br>";
     echo "<br>";
     echo "<br>";
...
while ($row = mysqli_fetch_row($lis)){   
    ...
    echo "<td width='5%' align='left'><a class='btn btn-success' href=EliminarCategoria.php?codCategoria=$row[0] style='text-decoration:none'>Eliminar</a></td>" ;
    echo "</tr>";
}  
echo "</table> </div>";  
?> 
