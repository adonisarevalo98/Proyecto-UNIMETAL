...
<input type="password" name="pass" class="form-control" value="" minlength="8" class="control" placeholder="Contraseña" required /><br>
</div>
<div class="form-group">
<label><h4 class="leter">Confirmar Contraseña</h4></label>
<input type="password" name="repass" class="form-control" value="" minlength="8" class="control" placeholder="Contraseña" required /><br>
</div>
<div class="form-group">
